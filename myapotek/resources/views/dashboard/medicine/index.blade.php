                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div style="padding: 15px; text-align: center;">
                                                                @if($d->image)
                                                                    <img  src="{{ asset('img/medicine-images/'.$d ->image) }}" height='200px'>
                                                                @else
                                                                    <b>(No image)</b>
                                                                @endif
                                                                <p>{{ $d ->description }}</p>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div style="padding: 15px" style="padding: 15px; text-align: center;">`;
                                                                if (data.image) {
                                                                    newData += `<img class="rounded" src="{{ asset('img/medicine-images/`+data.image+`') }}" height='200px'>`;
                                                                } else {
                                                                    newData += `<b>(No image)</b>`;
                                                                }
                                                                newData += `<p>`+formData.get('description')+`</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
